...
EM_JS(
    unsigned int,
    webGLInterfaceSetUniformMatrix4fv, (unsigned int programID, const char *uniformName, unsigned int uniformNameLength, float *matrixData), {
      ...
      var name = webGLInterfaceGetString(uniformName, uniformNameLength);
...
EM_JS(
    unsigned int,
    webGLInterfaceSetUniform4fv, (unsigned int programID, const char *uniformName, unsigned int uniformNameLength, float *vectorData), {
      var program = document.webGLModule.programs[programID];
...
EM_JS(
    unsigned int,
    webGLInterfaceSetUniform3fv, (unsigned int programID, const char *uniformName, unsigned int uniformNameLength, float *vectorData), {
      var program = document.webGLModule.programs[programID];
...
EM_JS(
    unsigned int,
    webGLInterfaceSetUniform1f, (unsigned int programID, const char *uniformName, unsigned int uniformNameLength, float floatData), {
      var program = document.webGLModule.programs[programID];
...
EM_JS(
    unsigned int,
    webGLInterfaceSetUniform1i, (unsigned int programID, const char *uniformName, unsigned int uniformNameLength, unsigned int intData), {
      var program = document.webGLModule.programs[programID];
