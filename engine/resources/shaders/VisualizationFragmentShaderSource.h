#ifndef DATA_GARDEN_VISUALIZATION_FRAGMENT_SHADER_SOURCE
#define DATA_GARDEN_VISUALIZATION_FRAGMENT_SHADER_SOURCE

#include <string>

const std::string VISUALIZATION_FRAGMENT_SHADER_SOURCE = R"(#version 300 es
